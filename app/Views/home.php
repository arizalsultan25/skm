...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/survei/bootstrap.min.css">
    ...
    <!-- Timpa File Bootstrap -->
    <link rel="stylesheet" type="text/css" href="css/survei/survei-bootstrap.min.css">
        ...
        <div id="dynamicReloadContainer">
            ...
            <div class=" navbar navbar-default navbar-fixed-top">
                <div class=" navbar-header   ">
                    ...
                    <img class="logo img-responsive" style="margin-left: 20px; height: 60px;" src="img/Inshot Logo.png" alt="SURVEI KUALITAS LAYANAN IT SUPPORT">
                </div>
            ...
            <div class=" outerframe    container  " id="outerframeContainer">
                ...
                <div id="main-row">
                    ...
                    <div class="  col-centered  space-col" id="main-col">
                        ...
                        <form id="limesurvey" name="limesurvey" autocomplete="off" class="survey-form-container form" action="<?= base_url('home/question') ?>" method="post">
