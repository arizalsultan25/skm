...
<section class="content-header">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="/admin/referensi-unsur/create" method="POST">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $item->nama ?></td>
                                        <td>
                                            <a href="/admin/referensi-unsur/update/<?= $item->id ?>" class="btn btn-sm btn-warning">Edit</a>
                                            <form action="/admin/referensi-unsur/<?= $item->id ?>" class="d-inline" method="POST">
                                                <?= csrf_field(); ?>
