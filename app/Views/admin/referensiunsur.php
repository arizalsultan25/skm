...
<section class="content-header">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="/admin/referensiunsur/create" method="POST">
                    ...
                    <div class="card-body">
                        <table id="example" class="table table-sm table-striped table-bordered" style=" width:100%">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($referensiunsur as $item) :
                                ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td><?= $item->nama ?></td>
                                        <td>
                                            <a href="/admin/referensiunsur/update/<?= $item->id ?>" class="btn btn-sm btn-warning">Edit</a>
                                            <form action="/admin/referensiunsur/<?= $item->id ?>" class="d-inline" method="POST">
                                                <?= csrf_field(); ?>
