        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="/admin/survei/create" method="POST">
                        <div class="card-body">
                            <?= csrf_field(); ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $item->end; ?></td>
                                        <td>
                                            <a href="/admin/survei/update/<?= $item->id; ?>" class="btn btn-sm btn-warning">Edit</a>
                                            <form action="/admin/survei/<?= $item->id ?>" class="d-inline" method="POST">
                                                <?= csrf_field(); ?>
