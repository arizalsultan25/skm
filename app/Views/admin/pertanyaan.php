        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="/admin/pertanyaan/create" method="POST">
                        <?= csrf_field(); ?>
                        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                foreach ($pertanyaan as $item) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/pertanyaan/update/<?= $item->id ?>" class="btn btn-sm btn-warning">Edit</a>
                                            <form action="/admin/pertanyaan/<?= $item->id ?>" class="d-inline" method="POST">
                                                <?= csrf_field(); ?>
